...
import cr.ac.ucenfotec.examen.repository.DepartamentoRepository;
...
/**
 * REST controller for managing {@link cr.ac.ucenfotec.examen.domain.Departamento}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class DepartamentoResource {
    ...
    public List<Departamento> getAllDepartamentos(@RequestParam(required = false) String filter) {
